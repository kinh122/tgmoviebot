...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [
            [
                InlineKeyboardButton('support', url='https://t.me/king12346i'),
                InlineKeyboardButton('channel', url='https://t.me/king12346i')
            ],
            ]
            ]
        ...
        buttons = [
            ...
            [
                InlineKeyboardButton('Series & Movie Club', url=f'https://t.me/king12346i')
            ]
            ]
        await query.answer()
        await client.send_cached_media(
        ...
        buttons = [[
            ...
            InlineKeyboardButton('updates', url='https://t.me/king12346i'),
            InlineKeyboardButton('movie club', url='https://t.me/king12346i')
            ],[
